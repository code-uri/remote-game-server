...
public interface IGameSessionService extends IEntityService<GameSession> {
    ...
    GameSession findOneByGameConnectorAndCorrelationIdAndStatus(String gameConnector, String correlationId, Status status);
    ...
    GameSession createGameSession(GameLaunchRequest glr, String player, String currency, GameSkin gameSkin, String gameConfiguration, Brand brand, String tenant, String correlationId);
