...
import aimlabs.gaming.rgs.settings.GameSettings;
...
@Slf4j
@RestController
@RequestMapping("/admin/game-settings")
@SecuredEndpoint
public class GameSettingsController extends AbstractEntityCurdController<GameSettings> {

    @Autowired
    private IGameSettingsService service;
}
