...
public class GameLaunchRequest implements Serializable {
    ...
    public GameLaunchRequest(String tenant, String network, String brand, String token, String gameId,
        ...
        // this.regulations = new HashSet<>(params.getOrDefault("regulation", new
        // ArrayList<>()));
