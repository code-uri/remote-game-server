package aimlabs.gaming.rgs.core.utils.date;
...
public class DateUtils {
    ...
    static final long ONE_HOUR_IN_MILLIS = 60000 * 60;
    static final long ONE_DAY_IN_MILLIS = 60000 * 60 * 24;
    /**
    ...
    public static Date endOfMonth(Date date) {
        LocalDateTime dateTime = dateToLocalDateTime(date);
        dateTime.plusMonths(1).withDayOfMonth(1).minusDays(1);
    ...
    public static Date addDaysToDate(Date date, int hours) {
        long curTimeInMs = date.getTime();
        Date afterAddingMins = new Date(curTimeInMs
                + (hours * ONE_DAY_IN_MILLIS));
        return afterAddingMins;
    }
