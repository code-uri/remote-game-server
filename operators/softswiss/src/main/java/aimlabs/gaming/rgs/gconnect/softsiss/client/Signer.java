...
@Slf4j
public class Signer {
    public static final String SIGN_HEADER = "X-Request-Sign";
     ...
     * Signs the raw JSON request body and injects {@link #SIGN_HEADER}.
     */
    public void injectHeader(final HttpHeaders headers, final byte[] body) {
        final String signature = sign(new String(body, StandardCharsets.UTF_8));
        headers.setDate(HttpHeaders.DATE, System.currentTimeMillis());
        headers.set(SIGN_HEADER, signature);
    }
