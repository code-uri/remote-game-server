...
@Getter
@Service
public class GravitonGameSupplierFactory implements GameSupplierServiceFactory {
    ...
    public static String connectorUid = "graviton-connector";
    ...
    public IGameSupplierService getInstance(Connector connector) {
        return new GravitonGameSupplierConnector(connector);
    }

    private class GravitonGameSupplierConnector implements IGameSupplierService {
        private final Connector connector;

        private final String secretKey;
        private final String nodeId;

        public GravitonGameSupplierConnector(Connector connector) {
            this.connector = connector;

            secretKey = (String) connector.getSettings().getOrDefault("salt", "Qubit");
